<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query=mysqli_query($con,"SELECT haslo FROM klient WHERE loginn='$profile'");
        $num=mysqli_fetch_array($query);
        if($num>0)
        {
         $con=mysqli_query($con,"UPDATE klient SET haslo='$newpwd' where loginn='$profile'");
...
<body>
    ...
    <section class="login-hero">
        <div class="login-sect">
            <form action="zmianaklient.php" name="chngpwd" method="post" >
